...
import { CubeIcon, RadioIcon, MonitorIcon, DownloadIcon } from '../components/Icons'
...
function downloadBlenderPlugin(setState: (s: 'idle' | 'busy' | 'done') => void): void {
    setState('busy')
    const zip = new JSZip()
                ...
                <div className='relative max-w-2xl mx-auto px-6 py-20 text-center space-y-10'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <p className='text-sm text-ice-600 max-w-md mx-auto'>
                            Receive a live Blender scene, snapshot it to OPFS, then preview the optimised deployment —
                            all in the browser.
                        </p>
                    </div>
                    ...
                    <div className='pt-4 flex flex-col items-center gap-3'>
                        ...
                        <div className='flex items-center gap-4 text-xs text-ice-600 font-mono'>
                            ...
                            <Link to='/dev' className='hover:text-tiffany-400 transition-colors'>
                                dev
                            </Link>
                            <Link to='/production' className='hover:text-tiffany-400 transition-colors'>
                                production
                            </Link>
                        </div>
                    </div>
