...
const HEAD_PRIORITY = ['mixamorig:Head', 'mixamorigHead', 'Head', 'mixamorig:HeadTop_End']
 ...
 */
export function findHeadBone(root: THREE.Object3D, override: string | null = null): THREE.Bone | null {
    if (override) {
 ...
 */
export function mapClipBones(clip: AnimationClip, root: THREE.Object3D): AnimationClip {
 ...
 */
export function restrictClipToRoot(clip: AnimationClip, root: THREE.Object3D): AnimationClip | null {
