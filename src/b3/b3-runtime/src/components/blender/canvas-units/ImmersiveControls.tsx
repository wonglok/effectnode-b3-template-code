...
export const CAMERA_INITIAL_RADIUS = Math.hypot(CAMERA_INITIAL_OFFSET.z, INITIAL_ORBIT_VERT) // ≈ 2.05
// Starting polar tilt (degrees from +Y) that reproduces the orbit vector above.
const INITIAL_POLAR_DEG = (Math.atan2(CAMERA_INITIAL_OFFSET.z, INITIAL_ORBIT_VERT) * 180) / Math.PI // ≈ 77.3
// Polar tilt bounds (degrees from +Y, 0 = straight overhead). Clamping to this
// above-horizon band keeps the camera from rolling underneath the character.
const MIN_POLAR_ANGLE = 5
const MAX_POLAR_ANGLE = 100
