...
export function LightFromData({ light, intensityScale = 1.0 / 10.0 }: LightFromDataProps) {
    ...
    switch (light.type) {
        ...
        default:
            ...
            return <pointLight position={position} quaternion={quaternion} intensity={intensity} color={color} />
    }
}
